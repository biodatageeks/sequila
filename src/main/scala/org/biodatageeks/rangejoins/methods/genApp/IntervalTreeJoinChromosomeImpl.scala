...
import org.biodatageeks.rangejoins.common.performance.timers.IntervalTreeTimer.{IntervalTreeBuild, IntervalTreeLookup}
import org.biodatageeks.rangejoins.genApp.Interval

object IntervalTreeJoinChromosomeImpl extends Serializable {
  ...
  def overlapJoin(sc: SparkContext,
    ...
    val intervalTree = IntervalTreeBuild.time {sc.broadcast(new IntervalTreeChromosome[Int](localIntervals.toList)) }
