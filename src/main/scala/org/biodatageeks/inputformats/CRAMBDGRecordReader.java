...
import htsjdk.samtools.CRAMBDGIterator;
...
public class CRAMBDGRecordReader extends RecordReader<LongWritable, SAMRecordWritable> {
    ...
    private long start;
    private long length;
    private CRAMBDGIterator cramIterator;
    ...
    public void initialize(InputSplit split, TaskAttemptContext context) throws IOException {
        ...
        cramIterator = new CRAMBDGIterator(seekableStream, boundaries, stringency);
    }
