...
public class ContainerBDGIO {
     ...
     */
    public static htsjdk.samtools.cram.structure.BDGContainer readContainer(final Version version, final InputStream inputStream) throws IOException {
        final htsjdk.samtools.cram.structure.BDGContainer container = readContainer(version.major, inputStream);
        if (container == null) {
     ...
     * @throws IOException
     */
    private static BDGContainer readContainer(final int major, final InputStream inputStream) throws IOException {
     ...
     * @throws IOException as per java IO contract
     */
    public static htsjdk.samtools.cram.structure.BDGContainer readContainerHeader(final int major, final InputStream inputStream) throws IOException {
        final htsjdk.samtools.cram.structure.BDGContainer container = new htsjdk.samtools.cram.structure.BDGContainer();
        final htsjdk.samtools.cram.structure.ContainerBDGHeaderIO containerHeaderIO = new htsjdk.samtools.cram.structure.ContainerBDGHeaderIO();
    ...
    private static htsjdk.samtools.cram.structure.BDGContainer readContainer(final int major, final InputStream inputStream, final int fromSlice, int howManySlices) throws IOException {

        final htsjdk.samtools.cram.structure.BDGContainer container = readContainerHeader(major, inputStream);
        if (container.isEOF()) {
            return container;
        }
    ...
    private static void calculateSliceOffsetsAndSizes(final htsjdk.samtools.cram.structure.BDGContainer container) {
     ...
     * @throws IOException as per java IO contract
     */
    public static int writeContainerHeader(final int major, final htsjdk.samtools.cram.structure.BDGContainer container, final OutputStream outputStream) throws IOException {
        return new htsjdk.samtools.cram.structure.ContainerBDGHeaderIO().writeContainerHeader(major, container, outputStream);
    }
     ...
     * @throws IOException as per java IO contract
     */
    public static int writeContainer(final Version version, final htsjdk.samtools.cram.structure.BDGContainer container, final OutputStream outputStream) throws IOException {
        {
            if (container.blocks != null && container.blocks.length > 0) {
                ...
                if (isFileHeaderContainer) {
                    ...
                    final int containerHeaderByteSize = new htsjdk.samtools.cram.structure.ContainerBDGHeaderIO().writeContainerHeader(version.major, container, outputStream);
        ...
        int length = new htsjdk.samtools.cram.structure.ContainerBDGHeaderIO().writeContainerHeader(version.major, container, outputStream);
        outputStream.write(byteArrayOutputStream.getBuffer(), 0, byteArrayOutputStream.size());
