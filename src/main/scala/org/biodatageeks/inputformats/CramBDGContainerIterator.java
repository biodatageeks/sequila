 ...
 */
public class CramBDGContainerIterator implements Iterator<BDGContainer> {
    private CramHeader cramHeader;
    private CountingInputStream countingInputStream;
    private BDGContainer nextContainer;
    private boolean eof = false;
    private long offset = 0;

    public CramBDGContainerIterator(final InputStream inputStream) throws IOException {
     ...
     * @throws IOException
     */
    protected BDGContainer containerFromStream(final Version cramVersion, final CountingInputStream countingStream) throws IOException {
        return htsjdk.samtools.cram.structure.ContainerBDGIO.readContainer(cramHeader.getVersion(), countingStream);
    }
    ...
    public BDGContainer next() {
        final BDGContainer result = nextContainer;
        nextContainer = null;
        return result;
    }
