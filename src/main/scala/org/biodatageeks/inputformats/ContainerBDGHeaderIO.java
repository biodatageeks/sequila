...
class ContainerBDGHeaderIO {

    public boolean readContainerHeader(final htsjdk.samtools.cram.structure.BDGContainer container, final InputStream inputStream)
            throws IOException {
        return readContainerHeader(2, container, inputStream);
    }

    public boolean readContainerHeader(final int major, final htsjdk.samtools.cram.structure.BDGContainer container, final InputStream inputStream)
            throws IOException {
     ...
     */
    public int writeContainerHeader(final int major, final htsjdk.samtools.cram.structure.BDGContainer container, final OutputStream outputStream)
            throws IOException {
