...
public class ContainerBDGParser {
    private final SAMFileHeader samFileHeader;

    public ContainerBDGParser(final SAMFileHeader samFileHeader) {
        this.samFileHeader = samFileHeader;
    }

    public List<CramCompressionRecord> getRecords(final htsjdk.samtools.cram.structure.BDGContainer container,
    ...
    public Map<Integer, AlignmentSpan> getReferences(final BDGContainer container, final ValidationStringency validationStringency) throws IOException {
