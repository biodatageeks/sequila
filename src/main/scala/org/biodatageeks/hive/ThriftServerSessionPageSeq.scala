...
import org.apache.spark.sql.hive.thriftserver.HiveThriftServer2Seq.{ExecutionInfo, ExecutionState}
import org.apache.spark.ui._
import org.apache.spark.ui.UIUtils._

/** Page for Spark Web UI that shows statistics of jobs running in the thrift server */
private[ui] class ThriftServerSessionPageSeq(parent: ThriftServerTabSeq)
