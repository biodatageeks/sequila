...
//
//object CnMopsCoverage extends SequilaApp {
//
...
//    val outputDirPath = runConf.output_path() + "/cnmops_output"
...
//
//    new CnMopsConverter().convertToCnMopsFormat(targetCountFiles, sampleNames, outputDirPath)
//  }
//
