...
import org.apache.spark.sql.hive.thriftserver.HiveThriftServer2Seq.{ExecutionInfo, ExecutionState, SessionInfo}
import org.apache.spark.ui.UIUtils.{formatDate, formatDurationVerbose}
import org.apache.spark.ui.{UIUtils, WebUIPage}

import scala.xml.Node

private[ui] class ThriftServerPageSeq(parent: ThriftServerTabSeq) extends WebUIPage("") with Logging {
