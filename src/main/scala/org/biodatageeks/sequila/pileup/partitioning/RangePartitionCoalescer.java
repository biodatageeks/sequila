...
/**
 * Source Code taken from gatk
 */
public class RangePartitionCoalescer implements PartitionCoalescer, Serializable, scala.Serializable {
  ...
  if (maxEndPartitionIndexes.get(i) + 1 >= partitions.size())
    System.out.println ();
