package org.biodatageeks.sequila.tests.rangejoins.ailist
...
class AIListTestSuite extends IntervalJoinBaseTestSuite {

  val classHolder : String = "org.biodatageeks.sequila.rangejoins.exp.ailist.AIList"

  test("Check org.biodatageeks.sequila.rangejoins.exp.ailist.AIList1") {
    spark
  ...
  test("Check org.biodatageeks.sequila.rangejoins.exp.ailist.AIList2") {
