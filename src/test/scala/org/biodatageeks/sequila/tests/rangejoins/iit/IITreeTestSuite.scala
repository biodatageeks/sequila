package org.biodatageeks.sequila.tests.rangejoins.iit
...
class IITreeTestSuite extends IntervalJoinBaseTestSuite {

  val classHolder : String = "org.biodatageeks.sequila.rangejoins.exp.iit.IITree"

  test("Check org.biodatageeks.sequila.rangejoins.exp.iit.IITree1") {
    spark
  ...
  test("Check org.biodatageeks.sequila.rangejoins.exp.iit.IITree2") {
