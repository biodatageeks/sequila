...
import org.biodatageeks.sequila.pileup.model.{CigarDerivedConf, QualityCache, ReadQualSummary}
...
class QualityCacheTestSuite extends FunSuite{
  ...
  test("Qual cache test"){
    ...
    val read0 = ReadQualSummary(10,12,Array[Byte](3,2,4,2,3,4,2,3), cigarConf0)
    val cigarConf1 = CigarDerivedConf.create(13, c)
    val read1 = ReadQualSummary( 13,14,Array[Byte](3,2,4,2,3,4,2,3), cigarConf1)
    val cigarConf2 = CigarDerivedConf.create(19, c)
    val read2 = ReadQualSummary(19,21,Array[Byte](3,2,4,2,3,4,2,3), cigarConf2)
    val cigarConf3 = CigarDerivedConf.create(31, c)
    val read3 = ReadQualSummary( 31,41,Array[Byte](3,2,4,2,3,4,2,3), cigarConf3)
