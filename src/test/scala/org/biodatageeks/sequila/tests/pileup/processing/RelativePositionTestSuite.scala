...
class RelativePositionTestSuite extends FunSuite{
  ...
  test("relative test #1") {
    ...
    val rs = ReadSummary(7801998, 7801998 + len, new Array[Byte](len), new Array[Byte](len), true, conf)
  ...
  test("relative test #2") {
    ...
    val rs = ReadSummary(220108224, 220108224 + len, new Array[Byte](len), new Array[Byte](len), true, conf)
  ...
  test("relative test #3") {
    ...
    val rs = ReadSummary(813652, 813744, new Array[Byte](len), new Array[Byte](len), true, conf)
  ...
  test("relative test #4") {
    ...
    val rs = ReadSummary(76032260, 76032391, new Array[Byte](len), new Array[Byte](len), true, conf)
